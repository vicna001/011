...
def banner():
    ...
    print(b + r + "001 Ransomware ")
    print(w + d + "My Instagram account")   
    print(b + y + " https://www.instagram.com/f_society00.exe?igsh=eGgycGN3eDlrcjE1")
    print(w + d + "My Telegram account  ")
    print(b + b + " @vecna001_011    ")
...
def start():
    ...
    os.system("clear")
    banner()
    print(r + "[!]" + w + " You are about to create a curse in vecna ! ")
    ask = str(input(r + "[!]" + w + " Shall we begin?  (y/n): ").lower())
    if ask in ("yes"):
        pass
    else:
    ...
    {w}.
    {d}Support us https://t.me/vecna001_011 !{w}
    """)
